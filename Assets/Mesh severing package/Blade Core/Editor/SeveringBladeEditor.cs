...
[CustomEditor(typeof(SeveringBlade))]
public class SeveringBladeEditor : Editor
{
	private static System.String generationLimitTooltip =	"Gets or sets the generation limit of this Severing_Blade instance. This value restricts how many times a game object may be shattered using Severing_Blade.Shatter(). A game object will only be able to shatter if Severing_Blade.Generation is less than Severing_Blade.GenerationLimit.";
	private static System.String cutsTooltip =				"Gets or sets the number of times the game object will be cut when Severing_Blade.Shatter() occurs.";
	private static System.String fillCutTooltip =			"Gets or sets whether the cut region should be triangulated. If true, the connected UvMapper component will control the vertex properties of the filled area. When the Severing_Blade is used on double-sided meshes with zero thickness, such as planes, this value should be false.";
	...
	{
		SeveringBlade source = (SeveringBlade)target;
