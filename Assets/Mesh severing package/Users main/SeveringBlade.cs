...
public class SeveringBlade: MonoBehaviour
{
	[SerializeField]
	...
	/// <summary>
	/// Gets or sets the generation limit of this Severing_Blade instance.
	/// This value restricts how many times a game object may be shattered
	/// using Severing_Blade.Shatter(). A game object will only be able to shatter
	/// if Severing_Blade.Generation is less than Severing_Blade.GenerationLimit.
	/// </summary>
	...
	/// <summary>
	/// Gets or sets the current generation of this Severing_Blade instance.
	/// By default, a game object is of generation 1. When a game object
	/// is shattered using Severing_Blade.Shatter() all new game objects
	...
	/// <summary>
	/// Gets or sets the number of times the game object will be cut when Severing_Blade.Shatter() occurs.
	/// </summary>
	public int Cuts
	{
		get { return cuts; }
	...
	/// When the Severing_Blade is used on double-sided meshes with zero thickness, such as planes, this value
	/// should be false.
	/// </summary>
	public bool FillCut
	{
	...
	/// <summary>
	/// Gets or sets the connected UvMapper. See the documentation of Severing_Blade.FillCut.
	...
	/// Severing_Blade.Split() using randomly generated planes passing through the point.
	/// </summary>
	/// <param name="point">
	...
	/// </param>
	public void Sever(Plane[] planes)
	{
		...
		if (planes != null && planes.Length > 0 && hull != null && !hull.IsEmpty)
		{
			...
			{
				Debug.LogWarning(name + " has no UvMapper attached! Please attach a UvMapper to use the Severing_Blade.", this);
			}
		}
	}
	...
	private void CreateNewGameObjects(IList<Hull> newHulls, out GameObject[] newGameObjects)
	{
		...
		for (int i = 0; i < newHulls.Count; i++)
		{
            ...
            // Set Severing blade
            SeveringBlade newSeveringBlade = newGameObject.GetComponent<SeveringBlade>();

            if (newSeveringBlade != null)
            {
                newSeveringBlade.hull = newHull;
            }
